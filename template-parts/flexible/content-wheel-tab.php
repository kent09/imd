...
<section class="wheel-tab text-center pt-114 pb-120">
    <!-- <div id="sample" style="height: 700px;">
    </div>
    <div id="sample-tooltip"></div> -->

    <?php if ($title) : ?>
        <div class="title font-size-13 text-green font-family-mont fw-bold text-uppercase"><?php echo $title; ?></div>
    <?php endif; ?>
    <?php if ($desc) : ?>
        <div class="description font-size-30 ml-auto mr-auto"><?php echo $desc; ?></div>
    <?php endif; ?>
